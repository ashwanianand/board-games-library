...
links:
  ...
  rules: "rules-en.pdf"
  flight-log: "flight-log.pdf"
  tutorial: "https://youtu.be/akX8WfuqUXo"
assetsPath: "game_files/skyteam/"
---

## Overview

Sky Team is a cooperative two-player dice game where players take on the roles of a pilot and co-pilot working together to land planes at airports around the world. Communication is key — players cannot show or discuss the values of their dice, only the placement decisions they make together.

## GAME SETUP

### Preparing the Control Panel

1. **Remove All Advanced Modules**  
   When opening the box for the first time, discard all Control Panel parts marked with the advanced module icon. These are for later games.

2. **Assemble the Plane Components**
...
2. All Flaps and Landing Gear switches show green.
3. The Axis is level (arrow pointing straight up).
4. Your final Speed is **less than** your Brakes.
